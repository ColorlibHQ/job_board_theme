...
// image default alt
if ( ! function_exists( 'job_board_img_default_alt' ) ) {
	function job_board_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'job_board_img_tag' ) ) {
	function job_board_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = job_board_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'job_board_anchor_tag' ) ) {
	function job_board_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'job_board_heading_tag' ) ) {
	function job_board_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'job_board_paragraph_tag' ) ) {
	function job_board_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'job_board_other_tag' ) ) {
	function job_board_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'job_board_button_element ' ) ) {
	function job_board_button_element( array $args ) {
