...
// enqueue css
function job_board_common_custom_css(){
    
    wp_enqueue_style( 'job_board-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= job_board_opt( 'job_board_theme_color' ) != '#131313' ? job_board_opt( 'job_board_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= job_board_opt( 'job_board_book_btn_color' ) != '#131313' ? job_board_opt('job_board_book_btn_color') : '';
		$bookBtnHoverBgColor     	= job_board_opt( 'job_board_book_btn_hvr_bg_color' ) != '#131313' ? job_board_opt('job_board_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = job_board_opt( 'job_board_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = job_board_opt( 'job_board_navbar_bg_color' ) != '#082b49' ? job_board_opt( 'job_board_navbar_bg_color') : '';
		$headerTop_col     		  = job_board_opt( 'job_board_top_header_color' );

		$headerTopBg      		  = job_board_opt( 'job_board_top_header_bg_color');
		$headerBg          		  = job_board_opt( 'job_board_header_bg_color') != '#ffffff' ? job_board_opt( 'job_board_header_bg_color') : '';
		$menuColor          	  = job_board_opt( 'job_board_header_menu_color' ) != '#131313' ? job_board_opt('job_board_header_menu_color') : '';
		$menuHoverColor           = job_board_opt( 'job_board_header_menu_hover_color' ) != '#808080' ? job_board_opt('job_board_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = job_board_opt( 'job_board_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = job_board_opt( 'job_board_header_drop_menu_bg_color' ) != '#ffffff' ? job_board_opt('job_board_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = job_board_opt( 'job_board_dropdown_menu_color' ) != '#131313' ? job_board_opt('job_board_dropdown_menu_color') : '';
		$dropMenuHovColor         = job_board_opt( 'job_board_dropdown_menu_hover_color' ) != '#808080' ? job_board_opt('job_board_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = job_board_opt( 'job_board_footer_widget_bg_color' );
		$footerwHeadColor   	  = job_board_opt('job_board_footer_widget_heading_color');
		$footerwTextColor   	  = job_board_opt('job_board_footer_widget_text_color');
		$footerwanchorcolor 	  = job_board_opt('job_board_footer_widget_anchor_color') != '#ffffff' ? job_board_opt('job_board_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = job_board_opt('job_board_footer_widget_anchor_hover_color') != '#ffffff' ? job_board_opt('job_board_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = job_board_opt('job_board_fof_bg_color');
		$foftonecolor			  = job_board_opt('job_board_fof_textone_color');
		$fofttwocolor			  = job_board_opt('job_board_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = job_board_opt('job_board_footer_widget_anchor_color') != '#9e9e9e' ? job_board_opt('job_board_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.job_board_part .btn_2, .blog_area a h2:hover
			{
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .job_board_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .job_board_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'job_board-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'job_board_common_custom_css', 50 );