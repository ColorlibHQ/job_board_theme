 ...
 */
	 ...
	 *
	 * Hook job_board_wrp_start
	 *
	 * @Hooked job_board_wrp_start_cb
	 *  
	 */
	do_action( 'job_board_wrp_start' );
	 ...
	 * column start.
	 *
	 * Hook job_board_blog_col_start
	 *
	 * @Hooked job_board_blog_col_start_cb
	 *  
	 */
	do_action( 'job_board_blog_col_start' );
	 ...
	 * column end.
	 *
	 * Hook job_board_blog_col_end
	 *
	 * @Hooked job_board_blog_col_end_cb
	 *  
	 */
	do_action( 'job_board_blog_col_end' );
	 ...
	 *
	 * Hook job_board_blog_sidebar
	 *
	 * @Hooked job_board_blog_sidebar_cb
	 *  
	 */
	do_action( 'job_board_blog_sidebar' );
 	
 	/**
	 * Hook for Blog, single, page, search, archive pages
	 * wrapper end with wrapper div, container, row.
 	 *
 	 * Hook job_board_wrp_end
 	 * @Hooked  job_board_wrp_end_cb
 	 *
 	 */
 	do_action( 'job_board_wrp_end' );
